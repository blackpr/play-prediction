...
This project uses **push-to-deploy** with GitHub Actions and CapRover:
...
1. **Setup CapRover** on Oracle Cloud (free tier)
2. **Create Supabase projects** (staging + production)
...
- 🚀 [CapRover Setup](./docs/CAPROVER_SETUP.md)
- 🔐 [GitHub Secrets Configuration](./docs/GITHUB_SECRETS.md)

### Architecture

```
GitHub → GitHub Actions → Tests → Migrations → CapRover → Production
```

**Features**:
- ✅ Zero-cost hosting (Oracle Cloud + Supabase free tiers)
- ✅ Automatic database migrations
- ✅ Fail-fast deployment (migrations run before deploy)
